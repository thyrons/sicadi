...
<title>Sicadi</title>
    <link href="../img/logosEmpresa/icono.jpg" type="image/x-icon" rel="shortcut icon" />
    ...
    <script type="text/javascript" src="../librerias/jsSicadi/funciones/funcion.js"></script>
    ...
    <script type="text/javascript">
        Ext.Loader.setPath({
            'Ext.ux.desktop': '../librerias/jsSicadi/escritorio/js/',
             MyDesktop: '../librerias/jsSicadi/escritorio/',
             uxLib: '../librerias/extjs/ux',
             extValidacion: '../librerias/jsSicadi/funciones/',
        });
